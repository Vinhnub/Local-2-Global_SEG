...
PKL_FILE = os.path.join(DATASET_DIR, DATASET_NAME, f"gnd_{DATASET_NAME}.pkl")
OUTPUT_DIR = os.path.join(project_root, "output", "stage1", "features")
...
if __name__ == "__main__":
    try:
        ...
        dataset_path = os.path.join(DATASET_DIR, DATASET_NAME, "jpg")

...
DATASET_DIR = os.path.join(os.path.dirname(project_root), "datasets")
PKL_FILE = os.path.join(DATASET_DIR, "roxford5k", "gnd_roxford5k.pkl")
OUTPUT_DIR = os.path.join(project_root, "data", "feature", "fire")
...
def extract_fire_features(image, net, norm_rgb, device, num_features=600):
    try:
        ...
        # Bắt buộc Chuẩn hóa L2 cho các đặc trưng cục bộ (Local Features)
...
if __name__ == "__main__":
    try:
        ...
        dataset_path = os.path.join(DATASET_DIR, "roxford5k", "jpg")
